...
const Card = () => {
  return (
    <>
    <div>
        <a href="#" className="flex flex-col  md:h-80  md:w-200 items-center bg-white border border-green-100 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-green-100 dark:border-green-500 dark:bg-green-800 dark:hover:bg-green-700">
